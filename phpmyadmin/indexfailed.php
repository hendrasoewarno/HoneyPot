...
<div class="error"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Cannot log in to the MySQL server</div>
...
<option value="1"  selected="selected">MariaDB</option>
	...
	<div id="pma_errors"><div class="error"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> mysqli_real_connect(): (HY000/1045): Access denied for user 'root'@'localhost' (using password: YES)</div></div>
	</div>
</div></body></html>