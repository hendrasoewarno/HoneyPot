...
def threaded_client(conn, address, count, logger):
    ...
    try:
        while True:       
            ...
            if request.startswith(b"QUIT"):
            ...
            elif request.startswith(b"OPTS"):
                response='200 OK.\r\n';
                ...
                if userid=="root" and password=="password":
                    ...
                    response='FTP  user/password  incorrect.\r\n';
            elif request.startswith(b"NOOP"):
                response='200 OK.\r\n';
            elif request.startswith(b"TYPE"):
                response='200 Binary mode.\r\n';
            elif request.startswith(b"PWD") or request.startswith(b"XPWD"):
                response='257 \"' + cwd + '"\r\n';
...
logger.info("FTP HoneyPot " + VERSION + " ready...") 
print("FTP HoneyPot " + VERSION + " ready...")
