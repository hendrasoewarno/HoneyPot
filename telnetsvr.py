...
/sbin/iptables  -A INPUT -p tcp --syn --dport 23 -m connlimit --connlimit-above 50 -j REJECT
...
#configure logger 
logging.basicConfig(filename='telnet.log', format='%(asctime)s %(message)s', 
					filemode='a')
